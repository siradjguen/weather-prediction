...
print(f"\n Step 2 — Missing values before KNN:")
...
print(f"\n   After KNN imputation — remaining nulls:")
...
df.to_csv("meteorological_data_cleaned_KNN.csv", index=False)
print(f"\n🎉 Done! Saved as 'meteorological_data_cleaned_KNN.csv'")
